...
- Which engine UI framework should be used for this screen? (e.g., UI Toolkit vs UGUI in Unity, Control nodes vs CanvasLayer in Godot, UMG vs CommonUI in Unreal, Dear ImGui vs RmlUi vs hand-rolled for SDL3 — SDL3 has no built-in UI framework)
