<p align="center">
  ...
  <p align="center">
    ...
    <br />
    54 agents. 72 skills. One coordinated AI team.
  </p>
</p>
...
The template includes agent sets for four engine paths. Use the set that matches your project:
...
| **SDL3 (C++ framework)** | `sdl3-specialist` | C++, SDL_gpu/Shaders, Audio, Build (CMake) |
...
- **Pick your engine** — use the Godot, Unity, Unreal, or SDL3/C++ agent set (or none)
